...
const PrivacyPolicy = () => {
  useSEO({ title: 'Privacy Policy', description: 'Privacy Policy – Nuzvid Agri Farms' });
    ...
    <div className="policy-page-wrapper">
      ...
      <div className="container">
        <div className="policy-content-wrapper">
          <p style={{ color: '#64748b', fontSize: '14px', marginBottom: '30px' }}>Last updated: September 14, 2025</p>

          <p>
            Nuzvid Agri Farms operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Nuzvid Agri Farms is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
          </p>
          <p>
          ...
          <h2>Contact</h2>
          <p>
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <strong>assist.naf@gmail.com</strong> or contact us at 19-55, thummala vari street, Nuzvid, Nuzvid, AP, 521201, IN.
          </p>
        </div>
      </div>
    </div>
